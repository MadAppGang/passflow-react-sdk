...
import { AoothPasswordPolicySettings } from '@aooth/aooth-sdk-js';
      ...
      {withMessages && (
        <div className='aooth-flex aooth-flex-col aooth-gap-[4px] aooth-mt-[4px]'>
          ...
          >
            ...
            />
            {generateMessage({ requireNumber, requireSymbol, requireLowerCase, requireUpperCase })}
          </p>
        </div>
      )}
    </>
...
FieldPassword.defaultProps = { withMessages: false, validationErrors: [], isError: false, className: '', disabled: false };
