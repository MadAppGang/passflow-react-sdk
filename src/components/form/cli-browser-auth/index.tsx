...
const CLIBrowserAuthForm: FC = () => {
  ...
  return (
    <Wrapper title='CLI Authentication' subtitle='Authenticate your CLI tool' className='passflow-cli-auth-wrapper'>
      <div className='passflow-form'>
        ...
        {state === 'pending' && (
          <>
            <div className='passflow-form-container'>
              <p className='passflow-form-text'>Click the button below to authenticate with your passkey.</p>
            </div>
            <Button
              size='big'
              variant='dark'
        ...
        {state === 'completed' && (
          <div className='passflow-form-container'>
            ...
            <p className='passflow-form-text'>You can close this window and return to your terminal.</p>
          </div>
        )}
